...
Select Joint Hierarchy: Selects all child and grandchild joints of whichever joint you last selected.
Add Joint: Adds all selected joints to the tree view, parenting them accordingly if their direct parents are included.
Remove joint: Removes any selected joints from the tool that you've selected in the tree view.
